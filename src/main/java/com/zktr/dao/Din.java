...
public class Din extends BaseDAO{
	public java.util.List<DinDAO> cha(){
		String sql = "SELECT hs_order.onumber, hs_users_message.uname\r\n"
				+ "FROM hs_order\r\n"
				+ "INNER JOIN hs_users_message ON hs_order.uid = hs_users_message.uid;";
	...
	public java.util.List<denglu> rizhi(){
		String sql = "select username,address,ip,isp,login_time from login_logs";
